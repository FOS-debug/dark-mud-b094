...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/dark-mud-b094)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/dark-mud-b094
```

A live public deployment of this template is available at [https://dark-mud-b094.templates.workers.dev](https://dark-mud-b094.templates.workers.dev)
